...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        stage.setResizable(false); // Disabling resizing

        // Adjust the stage size to be the same as the minimized size
        stage.setWidth(800); // Adjust the width as per your requirement
        stage.setHeight(600); // Adjust the height as per your requirement
